...
def main_worker(local_rank,world_size,rank_offset,config):
    ...
    #                                             collate_fn=validate_dataset.collate_fn,sampler=validate_sampler,pin_memory=True,num_workers=config.workers)
    logs = {}
...
if __name__ == '__main__':
    ...
    Config = train_config(name, ['efficientnet-b4'],  feature_layer=feature_layer, epochs=1,
                          batch_size=2, augment='augment1')
    Config.mkdirs()
